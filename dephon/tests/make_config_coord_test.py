...
from dephon.config_coord import SinglePoint, PotentialCurve, ConfigCoordDiagram, \
    CcdId
...
def test_make_ccd(excited_structure, ground_structure, dephon_init):
    ...
    expected = ConfigCoordDiagram(name="Va_O", potential_curves=[
