...
def test_eigenvalue_plotter(mocker):
    ...
    i2 = deepcopy(i1)
    i2.orbital_infos[0][0][2].formation_energy = 0.1

    i3 = deepcopy(i1)
    i3.orbital_infos[0][0][2].formation_energy = 0.2

    i4 = deepcopy(i1)
    i4.orbital_infos[0][0][2].formation_energy = 0.3

    plotter = EigenvalPlotter(orb_infos=[i1, i2, i3, i4],
