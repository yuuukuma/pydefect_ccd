...
def test_call_and_omega_and_str_and_shift_for_quartic():
    q = QuarticFittingCurve(a=1.0, b=1.0, c=1.0, Q0=1.0, dE=0.5)
    ...
    assert new.dE == pytest.approx(0.0)
...
def test_single_intersection():
    q1 = QuadraticFittingCurve(Q0=0.0, dE=0.0, a=1.0)
    q2 = QuadraticFittingCurve(Q0=1.0, dE=0.0, a=1.0)
